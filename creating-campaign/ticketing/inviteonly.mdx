...
<Steps>
    ...
    <Step title="Create code">
        <Info>
            For detailed instructions on how to create a promo code, please refer to our [tutorial here](/distribution/discountpromocode). Both manually and bulk generated codes can be created for invite-only tickets.
        </Info>
