...
<Steps>
  ...
  <Step title="Set Default Payment Method" stepNumber="2">
    After entering your payment information, check the "Set this as Default Payment" box for your preferred bank account or crypto wallet. Only one account can be default in each category. A green "Default" tag will appear next to it in the summary table after saving.![](Default-Payment.png)![](Default-Payment-2.png)
