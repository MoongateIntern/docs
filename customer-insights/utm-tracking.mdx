---
title: 'UTM Tracking'
description: 'Moongate supports UTM tracking, allowing you to gain a detailed understanding of where your campaign participants are 
joining from.'
---

UTM tracking is enabled by appending `?utm_(anything-you-want-to-track)=(anything)` to the back of your campaign's URL. 
