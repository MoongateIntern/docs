    ...
    <Accordion title="I can't see my NFT ticket/membership in my wallet.">
        ...
        <Steps>
            <Step title="You are checking a wallet which you haven't connected to Moongate.">
                ...
                To view your NFT in your non-custodial wallet, log in to Moongate, open the user settings panel, click ‘Manage’ to be taken to your non-custodial wallet, make sure the correct chain is selected, and then click "NFT."
                <img src="/user-guide/images/support/user-faq/view-non-custodial-wallet.gif"/>
            </Step>
