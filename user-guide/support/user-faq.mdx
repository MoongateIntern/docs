...
<AccordionGroup>
    ...
    <Accordion title="I can't see my NFT ticket/membership in my wallet.">
        ...
        3. **Your external wallet isn't detecting the NFT ticket/membership.** Please see our instructions [here](/user-guide/managing-wallet/manually-add-nft) on how to manually add an NFT to your wallet.
    </Accordion>
