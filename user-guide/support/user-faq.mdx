...
<AccordionGroup>
    ...
    <Accordion title="I can't see my NFT ticket/membership in my wallet.">
        ...
        provider's documentation for instructions. As an example, here'sS [how to add a new chain on Metamask](https://support.metamask.io/hc/en-us/articles/360043227612-How-to-add-a-custom-network-RPC#h_01G63GGCJH5GCYDYPH5RNWNZQ8).
        3. **Your external wallet isn't detecting the NFT ticket/membership**
    </Accordion>
