...
<AccordionGroup>
    ...
    <Accordion title="I can't see my NFT ticket/membership in my wallet.">
        ...
        1. **You are checking a wallet which you haven't connected to Moongate.**
        ...
        Simply log into the [Moongate user portal](app.moongate.id) and check the 'Pass' page.
        2. **You haven't configured your wallet to display NFTs on the same chain that the NFT ticket/membership is deployed on.**
        ...
        Refresh your wallet after adding the new chain and the NFT ticket/membership should appear.
        <Frame caption="How to manually add an NFT to a Metamask wallet">
            <img src="/user-guide/images/support/user-faq/manually add nft.gif"/>
        </Frame>
        If the NFT still isn't appearing, you might need to manually import the NFT. Please refer to your wallet provider's documentation for instructions on how to manually 
        ...
        button under your NFT ticket or pass on the Moongate portal.
    </Accordion>
