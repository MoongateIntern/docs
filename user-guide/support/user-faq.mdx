...
<AccordionGroup>
    ...
    <Accordion title="I can't see my NFT ticket/membership in my wallet.">
        ...
        Refresh your wallet after adding the new chain and the NFT ticket/membership should appear. If it still isn't appearing, you might 
        need to manually import the NFT.
