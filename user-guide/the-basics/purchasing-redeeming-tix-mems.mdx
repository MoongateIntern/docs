...
--
<Steps>
    <Step title="Visit the event/membership pagee">
    ...
    <Step title="Fill out required information">
        ...
        <img src="/user-guide/images/the-basics/purchasing-redeeming-tix-mems/full info.avif"/>
        <Warning>
            **If you are purchasing ticket(s) on behalf of someone else, please enable the "Buy for others" toggle and provide their email 
            address.** Due to the nature of NFTs and the blockchain, transferring a ticket(s) from your account to theirs at a later time 
