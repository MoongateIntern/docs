...
---
NFT tickets and membership passes may unlock associated benefits, such as discount codes, free tickets, exclusive merchandise, etc, both now and in the future. These benefits can be accessed from the 'Benefits' tab on the Moongate Portal.

<Steps>
    <Step title="Navigate to the 'Benefits' tab">
        <img src="/user-guide/images/the-basics/benefits/benefit tab.png"/>
