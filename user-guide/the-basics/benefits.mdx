...
<Steps>
    <Step title="Navigate to the 'Benefit' tab">
        <img height="558" width="420" src="/user-guide/images/the-basics/benefits/benefit tab.avif"/>
    ...
    <Step title="Claim and redeem the benefit">
        ...
        <img src="/user-guide/images/the-basics/benefits/pop-up.avif"/>
    </Step>    
</Steps>
...
You can filter benefits by their associated ticket/membership pass
Click "Claim".



Follow the instructions in the subsequent pop-up message to successfully redeem your benefit. The pop-up message and its contents can be reaccessed by repeating the above steps.