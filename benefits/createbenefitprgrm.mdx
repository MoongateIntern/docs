...
<Steps>
  ...
  <Step title="Navigate to the 'Benefits' tab">
  ...
  <Step title="Add basic benefit campaign information">
    ...
    When you are ready, scroll to the end of the page and click 'Next'. You are now ready to [create a benefit](/benefits/createbenefit)!
    <Tip>
